import { Badge, Divider, Group, Modal, Paper, Text } from '@mantine/core';
            ...
            <div className="space-y-4">
                ...
                <Paper withBorder radius="md" p="md">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <div>
                            <Text size="xs" c="dimmed">ชื่อสถาบันผู้แจ้ง</Text>
                            <Text size="sm" fw={500}>{`${report?.inst_name_th || ''}`.trim() || '-'}</Text>
                        </div>
                            ...
                            {selectedFiles.map((file, index) => (
                                ...
                                >
                                    {isImageFile(file.type) ? (
                                        ...
                                        <div className="flex h-28 w-full items-center justify-center rounded-md bg-gray-100 text-xs text-gray-500">
                                            FILE
                                        </div>
                                    )}
